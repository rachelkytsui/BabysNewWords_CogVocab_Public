...
Out of the 162 cognate (i.e., adding the 81 English cognate words and 81 French cognate words) and 162 non-cognate words (i.e., adding the 81 English non-cognate words and 81 French non-cognate words) on the matched list, bilingual infants produced an average of `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="cognate"),2],0)` cognate words (SD = `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="cognate"),3],2)`, range = `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="cognate"),4],0)` – `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="cognate"),5],0)`) and `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="non-cognate"),2],0)` non-cognate words (SD = `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="non-cognate"),3],2)`, range = `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="non-cognate"),4],0)` – `r round(matched_mean_cognates[which(matched_mean_cognates$cognate_status=="non-cognate"),5],0)`). The overall mean proportion of cognate words produced was `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="cognate"),2],1)` of words (SD = `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="cognate"),3],2)`, range = `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="cognate"),4],2)` – `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="cognate"),5],2)`), whereas the proportion of non-cognate words produced was `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="non-cognate"),2],1)` (SD = `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="non-cognate"),3],2)`, range = `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="non-cognate"),4],2)` – `r round(matched_mean_cognates_prop[which(matched_mean_cognates_prop$cognate_status=="non-cognate"),5],2)`). A Q-Q plot visualization as well as goodness-of-fit tests on the model’s residuals showed a good model fit, _D_ = `r round(testUniformity(Analysis1_matched_logistic_model)$statistic,2)`, $p = `r papaja::printp(testUniformity(Analysis1_matched_logistic_model)$p.value)`$. Table 1 also shows the coefficient estimates for the matched list model and Figure 1 Panel B visualizes the model. Similar to the patterns reported in the complete list model, there were significant effects of age and cognate status, once again showing that infants produced a greater proportion of cognates than non-cognates on the matched list. However, for the matched list there was no interaction between cognate status and age, indicating that the magnitude of the cognate advantage for this list was stable as infants grew older. 
...
Out of the complete list which contained `r nrow(CognateList_full_clean)` translation equivalent pairs (`r nrow(CognateList_full_clean[which(CognateList_full_clean$cognate_status=="cognate"),])` cognates and `r nrow(CognateList_full_clean[which(CognateList_full_clean$cognate_status=="non-cognate"),])` non-cognates), infants produced an average of `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="cognate"),2],0)` cognate pairs (SD = `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="cognate"),3],2)`, range = `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="cognate"),4],0)` – `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="cognate"),5],0)`) and `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="non-cognate"),2],0)` non-cognate pairs (SD = `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="non-cognate"),3],2)`, range = `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="non-cognate"),4],0)` – `r round(full_mean_total_TE[which(full_mean_total_TE$cognate_status=="non-cognate"),5],0)`). The proportion of cognate pairs produced was `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="cognate"),2],1)` (SD = `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="cognate"),3],2)`, range = `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="cognate"),4],2)` – `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="cognate"),5],2)`) whereas the proportion of non-cognate pairs produced was `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="non-cognate"),2],1)` (SD = `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="non-cognate"),3],2)`, range = `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="non-cognate"),4],2)` – `r round(full_mean_prop_TE[which(full_mean_prop_TE$cognate_status=="non-cognate"),5],2)`). A Q-Q plot visualization and goodness-of-fit tests on the model’s residuals revealed that our model showed a good model fit, _D_ = `r round(testUniformity(Analysis2_full_logistic_model)$statistic,2)`, $p = `r papaja::printp(testUniformity(Analysis2_full_logistic_model)$p.value)`$. Table 2 shows the coefficient estimates for the model and Figure 2 Panel A visualizes the model. There were significant effects of age and cognate status, showing that overall infants produced a greater proportion of cognates than non-cognates. Similar to the pattern reported in the first set of analyses, the interaction between age and cognate status suggested a slightly steeper learning curve for non-cognates than cognates, although an advantage for cognates was still apparent even at 27 months.
