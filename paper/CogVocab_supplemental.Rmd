...
papaja::apa_table(TableS2, format.args = list(digits = 3),
                  col.names =c("","Estimate", "$SE$","$z$","$p$","Estimate", "$SE$","$z$","$p$"),
                  align=c("l","c","c","c","c","c","c","c", "c"),
                  col_spanners = list("Complete list" = c(2,5), "Matched list" = c(6,9)),
                  caption="Table S2. Coefficient estimates from the mixed-effects logistic models predicting proportion of translation equivalent pairs produced.",
                  landscape = FALSE)
```
